...
<div class="cuadro9">
<form name="form1" method="post" action="reportes/seleccion_usuarios.php">
<center><input type="submit" class="usuarios" id="boton" value="Usuarios">
</form>
</div>

<div class="cuadro10">
<form name="form2" method="post" action="reportes/seleccion_productos.php">
<center><input type="submit" class="productos" id="boton" value="Artículos">
</form>
</div>

<div class="cuadro11">
<form name="form3" method="post" action="reportes/seleccion_prestamos.php">
<center><input type="submit" class="prestamos" id="boton" value="Préstamos">
</form>
</div>

<div class="cuadro12">
<form name="form4" method="post" action="reportes/seleccion_matricula.php">
<center><input type="submit" class="matricula" id="boton" value="Matrícula">
</form>
</div>

<div class="cuadro14">
<form name="form5" method="post" action="reportes/seleccion_categoria.php">
...
<div class="send1">
<center><input type="submit" class=send id="boton" value="Generar Reporte" onClick="alert('Seleccione el tipo de reporte que decea generar')">
</div>
</form>
</div>
</div>
