...
<title>inicio</title>
<link rel="stylesheet" href="../log/css/style33.css">
<style type="text/css">
<!--
.Estilo1 {
...
<div class="imglogin"><img src="../img/login.png" alt="img" width="329" height="436"></a></div>
...
<form id="form1" name="form1" method="POST" action="<?php $_SERVER["PHP_SELF"];?>">
  ...
  <p>
    <label>
      <input type="password" placeholder="Ingrese su contraseña" name="contrasena" id="contraseña" />
      </label>
  </p>
  <p>&nbsp;</p>
  <p>
...
<div class="falso">
<p>&nbsp; </p>
<text>Usuario o Contraseña incorrecto</text>
</div>

<div class="registrarse Estilo4">
  <p>&nbsp;</p>
  <p><strong><a href="../demo/index.html"><button class="registro" id="registro">Regresar</button></a></strong></p>
</div>
</body>
</html>
